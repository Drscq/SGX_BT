...
const TYPE_UNSIGNED_SIZE_SGX BUCKET_DUMMY_BLOCK_CAPACITY_SGX = 43;
const TYPE_UNSIGNED_SIZE_SGX BUCKET_SIZE_SGX = BUCKET_REAL_BLOCK_CAPACITY_SGX + BUCKET_DUMMY_BLOCK_CAPACITY_SGX;
...
namespace TreeConfigSgx {
    inline constexpr TYPE_PATH_SIZE_SGX HEIGHT = 17;
